...
import br.com.easy.quality.inspecao.read.common.InspecaoReadMapper;

@Component
public class InspecaoReadDataBaseAdapter implements InspecaoReadDataBase {

	@Autowired
	private InspecaoRepositoryCustom inspecaoRepositoryCustom;

	@Autowired
	private InspecaoReadMapper inspecaoReadMapper;
