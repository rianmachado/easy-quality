...
public class TransactionalEventPublisher implements EventPublisher {
	...
	private final KafkaTemplate<String, AvroEvent> kafkaTemplate;

	private final EventConverter converter;

	@Autowired
	public TransactionalEventPublisher(@Value("${loggin.questionatio.topic}") final String topicName,
			final KafkaTemplate<String, AvroEvent> kafkaTemplate, final EventConverter converter) {
	...
	private void onSuccess(final SendResult<String, AvroEvent> result) {
